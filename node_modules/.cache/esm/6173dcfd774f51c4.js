let connectToMongo,checkIfUser,userHasEnoughStars,handleTransaction,checkBalance,giveStars,takeStars,handleMessage;_774‍.w("./backend/main",[["connectToMongo",["connectToMongo"],function(v){connectToMongo=v}],["checkIfUser",["checkIfUser"],function(v){checkIfUser=v}],["userHasEnoughStars",["userHasEnoughStars"],function(v){userHasEnoughStars=v}],["handleTransaction",["handleTransaction"],function(v){handleTransaction=v}],["checkBalance",["checkBalance"],function(v){checkBalance=v}],["giveStars",["giveStars"],function(v){giveStars=v}],["takeStars",["takeStars"],function(v){takeStars=v}]]);_774‍.w("./handleMessage",[["default",["handleMessage"],function(v){handleMessage=v}]]);require("dotenv").config();
...
slackEvents.on("error", _774‍.g.console.error);
