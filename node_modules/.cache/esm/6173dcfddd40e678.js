let connectToMongo,checkIfUser,userHasEnoughStars,handleTransaction,handleMessage;_dd4‍.w("./backend/main",[["connectToMongo",["connectToMongo"],function(v){connectToMongo=v}],["checkIfUser",["checkIfUser"],function(v){checkIfUser=v}],["userHasEnoughStars",["userHasEnoughStars"],function(v){userHasEnoughStars=v}],["handleTransaction",["handleTransaction"],function(v){handleTransaction=v}]]);_dd4‍.w("./handleMessage",[["default",["handleMessage"],function(v){handleMessage=v}]]);require("dotenv").config();
...
slackEvents.on("error", _dd4‍.g.console.error);
