let connectToMongo,handleStar,checkIfUser,userHasEnoughStars,handleTransaction;_af6‍.w("./backend/main",[["connectToMongo",["connectToMongo"],function(v){connectToMongo=v}],["handleStar",["handleStar"],function(v){handleStar=v}],["checkIfUser",["checkIfUser"],function(v){checkIfUser=v}],["userHasEnoughStars",["userHasEnoughStars"],function(v){userHasEnoughStars=v}],["handleTransaction",["handleTransaction"],function(v){handleTransaction=v}]]);require("dotenv").config();
...
slackEvents.on("error", _af6‍.g.console.error);
